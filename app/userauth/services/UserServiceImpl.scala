 ...
 */
class UserServiceImpl @Inject() (userDAO: UserDAO)(implicit ex: ServiceExecutionContext) extends UserService {
  ...
  def create(createUser: CreateUser, loginInfo: LoginInfo): Future[User] = {
    userDAO.create(createUser, loginInfo)
  }
